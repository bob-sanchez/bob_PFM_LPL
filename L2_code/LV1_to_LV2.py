...
hout_dir = '/scratch/bob/LV1_2017/out/' #where the LV1 history files are located
...
time_filter_L1(h_out_dir, L1_short_list, out_dir,step_start) #subsamples, slow step
